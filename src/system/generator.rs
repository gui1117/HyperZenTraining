...
impl<'a> ::specs::System<'a> for GeneratorSystem {
    type SystemData = (::specs::WriteStorage<'a, ::component::Generator>,
    ...
    fn run(
        &mut self,
        (mut generators, mut bodies, mut momentums, mut avoiders, mut bouncers, mut dynamic_erasers, mut dynamic_draws, mut dynamic_graphics_assets, mut lives, mut contactors, mut physic_world, config, entities): Self::SystemData,
    ) {
