...
impl<'a> ::specs::System<'a> for TurretControlSystem {
    type SystemData = (
        ::specs::ReadStorage<'a, ::component::Turret>,
    ...
    fn run(
            ...
            (&turrets, &bodies, &mut momentums, &*entities).join()
        {
            ...
            momentum.ang_force = Some(
                pos.rotation
                    .rotation_to(&::na::UnitQuaternion::rotation_between(
                        &::na::Vector3::new(0.0, 0.0, 1.0),
                        &(laser_pos.translation.vector - pos.translation.vector),
            ...
            let world_trans = ::na::Isometry3::from_parts(
                ::na::Translation::from_vector(
                    pos.translation.vector + ray_length / 2.0 * shoot_dir,
                ),
                pos.rotation,
            )
